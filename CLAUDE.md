...
- Chapters stand alone; reference another chapter's model in one line rather than re-teaching it. Every chapter carries at least one `[DIAGRAM: …]` marker.
